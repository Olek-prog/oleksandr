...
const projects = [
  ...
  },
  {
    id: 9,
    name: 'Mused',
    desc: 'A modern mobile application with advanced features and seamless user experience. Built with cutting-edge technologies for optimal performance and user engagement.',
